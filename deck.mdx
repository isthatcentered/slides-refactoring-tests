...
- Ui peut fonctionner mm si test cassé  
- Aka accessoirement Aucune valeur, not what we care about (aka showing a loader))
...
- Protégé refactor
- Gagné en valeur au passage: Test casse seullemnt si cassé pour utilisateur 
