...
- Mais difficile identifier attendu
...
- Sais immédiatement pb et fix: Passer gagnant
...
- Se sert de connaissance fonctionnement interne pour tester
...
- Plutot declancher refresh via event page -> vérifie call getData() set loading true
...
- Objectif test: vérifier pour chaque clé en erreur -> string associée
- Mais comme spécifié msg erreur -> Test aussi msg validation
...
- Si spec msg validation change -> test casse
...
- Si ldap plus valide
- Aka Casse si règles collab changent
...
- Tout peut changer dans collab réel test continue passer
