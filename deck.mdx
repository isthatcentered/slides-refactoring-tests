...
- teams/applis/clients travaillé (pizza team size ou geants)
- j'ai aussi l'experience pour reconnaitre/prévoir avantages et inconvénients solution celon contexte
- Veut pas dire toujours raison/pas mieux que ce que j'ai proposé, mais bon paquet choses apprises et découvertes au fil années à partager
...
- AKA feedback constant, immédiat et automatique bon fonctionement appli
- Source de vérité:
...
- Parait idéal, 
- Concentre sur piece puzzle/feature, tests débrouillent avec reste
- = Journée beaucoup moins fatiguante (charge mentale focus one thing)
- = Avance + vite
- = + features
- = - bugs
- Ca = dans l'ideal
...
- donc si ils m'empêchent d'avancer vite/dur comprendre, ils sautent
