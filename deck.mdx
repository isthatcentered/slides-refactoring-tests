...
- Note, pour tous exemples, pas besoin lire, ils sont difficiles à comprendre, c'est le but, suis là pour mettre en valeur étapes importantes
- (z'allez comprendre pkoi je dis ça au prochain slide)
  
- Dump ensemble cas tests pour page
- Tout caser ensemble, verification validation/redirection/loading state, etc
...
- Propose celle là mais pleins d'autres
- Pouvez mm l'inventer, 
- L'important = Aide découvrir cas spéciaux feature/penser à tout


- Condition = qu'est-ce qui rend ce test spécial (pré-condition qui rend scénario spécial)
...
- Re-scoper via convention nommage
...
- [Localiser assertion] puis [actions] puis [setup]
- Ici mélangées
- Dur trouver rapidement info

- Comment mieux ?
- Identifié trois groupe:
- A, A, A
- Ajouter espaces  
- + add spaces
