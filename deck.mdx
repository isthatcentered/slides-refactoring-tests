...
<a href="https://www.youtube.com/watch?v=WSkOi0Ax-sQ" target="_blank">   
    <img
        style={{display: "block",borderRadius: 5, boxShadow: "0 4px 6px -1px rgba(0,0,0,.2),0 2px 4px -1px rgba(0,0,0,.16)"}} 
        src={videoCapSrc}
        alt="" 
    />
    <span style={{fontStyle:"italic","display":"block","textAlign":"center","fontSize":"28px","paddingTop":"16px"}}>View the talk (French)</span>
</a>
...
- John doe = arrive pas à identifier objets passés
...
- Aka test délégation: méthode appelé avec bon params = working
- Ici, pb claire, pas reçu ce que j'attendais
...
- Mais ici pas retour, rien à transformer. Peux pas modifier résultats comme avant 
- Objectif: pouvoir identifier rapidement reçu et attendu
- Comment ?


- Tagger objets
- Si valeurs pas utilisées, juste remplacer par string
- Ici besoin, donc via fonction
