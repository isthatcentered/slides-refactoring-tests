...
- Conctre sur actions
- Que 5 lignes
- Impossible comprendre ce qui se passe 
- Suite instructions ultra détaillée, à nous donner sens
- Cmment mieux ?


- Objectif: Trouver concepts sous jacent et officialiser
...
- Mis en valeur pièce comptent
- Dans test parfois valeurs doivent être spécifiques, souvent on s'en moque 
- Dur savoir quand
 
 
- Valeurs suspectes = montrer si valeur sans importance
...
- Ici message erreur test est complètement abstrait 
...
- Clarifié détails important
- Rendu éviden ce qui fait test pass/fail dans valeurs/objets
- Opportunité ++ précision dans nommage objets  
...
- Renommer objet en fonction role dans test
- Pas son type (user)
...
- Comprendre 
- Comment fonctionnement/etapes
- Cibler rapidement détails font test pass/fail rapidement
...
<Chapter emojis="🎰🤡" title="Meaningless values" />
...
<Chapter emojis="🧠🗑" title="Giant diff" />
...
- Vu besoin identifier rapidement valeurs et pb
- ++ quand juste vérifier passage objet
...
<UselessFailurRefactors active={2}/>
...
- Vu comment 
- donner context à valeurs
- Faciliter identification pb
- Faciliter debugging delegation
...
- Se sert de l'api privée/etat interne pour tester
...
<BorkenButWorkingRefactors active={0} />
...
- Autre exemple + incidieux
- Dépendance interne (test cass autre partie spec change)
...
- Faciliter prise en main via structure en conventions communes
...
- Faciliter compréhension via simplification language et mise en valeur détails importants
...
- Accélérer le debugging clarifiant msg erreur
...
- Avoir test cassent pour bonne raison en supprimant dépendance implicites
...
- Chaque refactor apporte bout mm bénéfices:
- Surface débug réduite
- Meilleur compréhension pb
- Rapprochement spec (language)
