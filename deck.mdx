...
import {StructureRefactors, ExpressivenessRefactors, FeedbackRefactors, FlexibilityRefactors}  from "./src/components/refactor-table"
...
- Onboarding + rapide -> Moins à connaitre quand arrive sur test
- Aidé à mettre à jour cas spéciaux
...
<ExpressivenessRefactors active={0}  />
