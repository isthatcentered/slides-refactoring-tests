...
import TestReport, { Matchers } from "./components/test-report"
...
- Test hardcore devient problématique quand
- Dure à lire plus pression = bye bye
- = Test premier truc à sauter
...
- Si contribution facile lors évolution
- Pas réinventer roue
...
- test = recette
- Doit être compréhensible si faire évoluer
- Recette impérative vs declarative
- Expressivité = Trouver bon niveau de détail
